...
The project uses short videos from the **Perception Test (Google Deepmind)** train MCQ split and treats KARL as an image tokenizer applied to sampled video frames. The goal is to build focused analysis probes around compression, reconstruction, and latent attention behavior.
